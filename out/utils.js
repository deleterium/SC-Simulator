...
export class utils {
    ...
    static hexstring2messagearray(in_hexstr) {
    ...
    static messagearray2hexstring(in_array) {
        let ret = "", val;
    ...
    static messagearray2superregister(in_array) {
        let ret = 0n;
    ...
    static superregister2messagearray(in_superregister) {
        let ret = [0n, 0n, 0n, 0n];
    ...
    static string2hexstring(in_str) {
        var byarr = [];
        var ret = "";
        var c, c1, i, j;
    ...
    static hexstring2string(in_hexstr) {
        let c1, c2, c3, c4, cc;
        let i = 0, ret = "";
        do {
