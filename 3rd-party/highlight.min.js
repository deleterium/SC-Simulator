/*!
  ...
  Tunned for SmartC: https://github.com/deleterium/SmartC
 */
...
begin:"(-?)(\\b0[xX][a-fA-F0-9_\']+|(\\b\\d[\\d_\']*(\\.[\\d\']*)?|\\.[\\d\']+)([eE][-+]?[\\d\']+)?)"
}],relevance:0},c={className:"meta",begin:/#\s*[a-z]+\b/,keywords:{
keyword:"if else endif define undef pragma program ifdef ifndef include"
...
keyword:["asm","break","case","const","continue","default","do","else","exit","for","goto","halt","if","inline","register","return","sizeof","sleep","struct","switch","while"],
...
beginKeywords:"struct",end:/[{;:<>=]/,contains:[{
beginKeywords:"struct"},n.TITLE_MODE]}]),exports:{preprocessor:c,
